<template>
  <div class="fixed top-4 sm:top-6 left-1/2 transform -translate-x-1/2 z-50">
    <Dock
      direction="middle"
    ...
    >
      ...
      >
        <component
          :is="item.icon"
          class="h-4 w-4 sm:h-5 sm:w-5 text-green-600/80 hover:text-green-700 transition-colors dark:text-green-400/80 dark:hover:text-green-300"
        />
      ...
      <DockIcon class="cursor-pointer" @click="toggleColorMode">
        <Sun
          v-if="isDark"
          class="h-4 w-4 sm:h-5 sm:w-5 text-yellow-600/80 hover:text-yellow-700 transition-colors dark:text-yellow-400/80 dark:hover:text-yellow-300"
        />
        <Moon
          v-else
          class="h-4 w-4 sm:h-5 sm:w-5 text-orange-600/80 hover:text-orange-700 transition-colors dark:text-orange-400/80 dark:hover:text-orange-300"
        />
      </DockIcon>
    </Dock>
  </div>
